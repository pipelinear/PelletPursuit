...
public class Player extends Sprite {
    ...
    public void update(double dt, GameMap map) {
        ...
        // reasoning.
        boolean canMove = !map.isWall(nc, nr) && !map.isOutOfGrid(nc, nr);
        // This line tells us that the player can move if the next column/row is not a
        // wall and if it is not outside of the grid.
        if (canMove) {
            x = nx;
            y = ny;
        }
